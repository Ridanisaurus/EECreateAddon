...
public class EECreateTags {
	public static final Function<String, TagKey<Item>> MATERIAL_CRUSHED_ORE = material -> getItemTag(new ResourceLocation(EECreateAddon.CREATE, "crushed_raw/" + material));
